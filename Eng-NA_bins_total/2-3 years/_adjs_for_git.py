...
f = csv.reader(open('corpus_adjs_edits.csv', 'rU'))
y_d = list(list(itertools.takewhile(lambda x: x is not None, column))
     for column in itertools.izip_longest(*f))
...
#outfile_adjs_strings = open('age_2_child_english.txt', 'w')

#outfile_adjs_strings.write('Age 2 Child-Directed\n\n')

#for x in adj_seq_list_d:
#    outfile_adjs_strings.write(str(list(reversed(x)))+', ')
#outfile_adjs_strings.write('\n\nAge 2 Child-Produced\n\n')
#for x in adj_seq_list_p:
#    outfile_adjs_strings.write(str(list(reversed(x)))+', ')
...
print "age 4, this how many total adj strings directed", len(interim_d)
